...
import { del, set, get, has, ownKeys } from '../../src/defObserver'
...
describe('reactivity/computed', () => {
  it('should return updated value', () => {
    ...
    const cValue = computed(() => get(value, 'foo'))
  ...
  it('should compute lazily', () => {
    const value = reactive<{ foo?: number }>({})
    const getter = jest.fn(() => get(value, 'foo'))
  ...
  it('debug: onTrack', () => {
    ...
    const c = computed(
      () => (obj.foo, has(obj, 'bar'), Object.keys(ownKeys(obj))),
      {
        onTrack,
      }
    )
