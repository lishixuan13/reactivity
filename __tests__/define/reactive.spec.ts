...
import { del, set } from '../../src/defObserver'
import { reactive, isReactive, markRaw, toRaw } from '../../src/reactive'
...
describe('reactivity/reactive', () => {
  ...
  test('should not pollute original object with Proxies', () => {
    const original: any = { foo: 1, bar: null }
